describe('Test transactions', () => {
  context('Test transactions page', () => {
    ...
    it('Test that pagination works correctly', () => {
      ...
      cy.get('.v-progress-linear__buffer').should('not.exist')
      // Check that pagination shows the correct number
      cy.get('[data-testid="transactions-table"] .v-data-footer__pagination').should('contain.text', '1-20 of 25', {
        timeout: 10000
      })
      cy.get('[data-testid="create-transaction-button"]', { timeout: 10000 }).should('be.visible')

      // Go to next page
      cy.get('[data-testid="transactions-table"] .v-data-footer__icons-after .v-icon').click()

      // Check that the correct number of transactions are shown
      cy.get('.transaction-row').should('have.length', 5)

      // Check that pagination shows the correct number
      cy.get('[data-testid="transactions-table"] .v-data-footer__pagination').should('contain.text', '21-25 of 25')
      ...
      // Go to previous page
      cy.get('[data-testid="transactions-table"] .v-data-footer__icons-before .v-icon').click()

      // Check that pagination shows the correct number
      cy.get('[data-testid="transactions-table"] .v-data-footer__pagination').should('contain.text', '1-20 of 24')
      ...
      // Check that pagination shows the correct number
      cy.get('[data-testid="transactions-table"] .v-data-footer__pagination').should('contain.text', '1-20 of 21')
      ...
      // Check that pagination shows the correct number
      cy.get('[data-testid="transactions-table"] .v-data-footer__pagination').should('contain.text', '1-5 of 21')
